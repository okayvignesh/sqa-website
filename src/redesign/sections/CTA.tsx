          ...
          <div className="relative rounded-[32px] overflow-hidden p-10 sm:p-16 bg-ink-900 text-white">
            ...
            <div className="relative max-w-3xl">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <BookDemoButton className="inline-flex items-center justify-center gap-2 h-12 px-6 rounded-full text-[15px] font-medium text-ink-900 bg-white hover:bg-white/95 hover:-translate-y-px transition-all shadow-[0_10px_30px_-10px_rgba(255,255,255,0.45)]">
