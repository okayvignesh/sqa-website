        ...
        <div className="py-12 md:py-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="col-span-2">
              ...
              <p className="mt-4 text-sm text-text-secondary max-w-xs">
                AI-powered test automation and ALM platform that unifies your entire testing workflow.
              </p>
              ...
              <div className="mt-6">
                <a
                  href="https://discord.gg/e58NZySa2T"
                  target="_blank"
                ...
                >
                  <Button
                    variant="secondary"
                    size="sm"
                    className="gap-2 bg-[#5865F2] hover:bg-[#4752C4] text-white border-0"
                  >
          ...
          <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-text-tertiary">
              &copy; {new Date().getFullYear()} Simplify3x Software Pvt Ltd. All rights reserved.
            </p>
            <p className="text-sm text-text-tertiary">
              Bengaluru, India
            </p>
